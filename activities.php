								...
								<table>
									...
									<tbody>
										...
										<tr class="cnb">
											...
											<td class="product-name">
												<a href="#"><h6>A review of the social protection policies and responses in health in the times of COVID-19 crisis</h6></a>
											</td>

											<td class="">
												<p>The overall activities for this project encompassed a multifaceted approach, beginning with extensive research that involved the review of international standards and local healthcare policies. Additionally, dialogues were strategically conducted at various levels, encompassing local, provincial, and federal domains, with each level facilitating in-depth discussions and feedback collection. These dialogues culminated in a comprehensive analysis of the existing healthcare protection measures. Finally, media dissemination was achieved through the publication of policy briefs and research reports, ensuring the findings and recommendations reached a wider audience and policy stakeholders, contributing to the enhancement of social health protection in Nepal. </p>
											</td>
											...
											<td class="product-thumbnail">
												<a href="assets/images/cb/activities/17.jpg" target_blank>
													<img src="assets/images/cb/activities/17.jpg" alt="Image">
												</a>
											</td>
